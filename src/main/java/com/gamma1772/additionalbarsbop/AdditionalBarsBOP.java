...
import com.gamma1772.additionalbarsbop.registries.ABItemsBOP;
...
//	private static <T extends RegistryObject<T>> void handleMissingMappings(RegistryEvent.MissingMappings<T> event, String modID, Function<String, T> handler) {
