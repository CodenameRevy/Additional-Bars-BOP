...
import com.gamma1772.additionalbars.content.block.BlockTypeEnum;
...
import com.gamma1772.additionalbarsbop.util.BOPBlockTypeEnum;
...
public class ABBlocksBOP {
	...
	public static final RegistryObject<Block> FIR_BARS = BOP_BLOCKS.register("fir_bars", () -> createBarsBlock(BOPBlockTypeEnum.BOP, BlockTypeEnum.REGULAR));
	public static final RegistryObject<Block> REDWOOD_BARS = BOP_BLOCKS.register("redwood_bars", () -> createBarsBlock(BOPBlockTypeEnum.BOP, BlockTypeEnum.REGULAR));
	public static final RegistryObject<Block> CHERRY_BARS = BOP_BLOCKS.register("cherry_bars", () -> createBarsBlock(BOPBlockTypeEnum.BOP, BlockTypeEnum.REGULAR));
	public static final RegistryObject<Block> MAHOGANY_BARS = BOP_BLOCKS.register("mahogany_bars", () -> createBarsBlock(BOPBlockTypeEnum.BOP, BlockTypeEnum.REGULAR));
	public static final RegistryObject<Block> JACARANDA_BARS = BOP_BLOCKS.register("jacaranda_bars", () -> createBarsBlock(BOPBlockTypeEnum.BOP, BlockTypeEnum.REGULAR));
	public static final RegistryObject<Block> PALM_BARS = BOP_BLOCKS.register("palm_bars", () -> createBarsBlock(BOPBlockTypeEnum.BOP, BlockTypeEnum.REGULAR));
	public static final RegistryObject<Block> WILLOW_BARS = BOP_BLOCKS.register("willow_bars", () -> createBarsBlock(BOPBlockTypeEnum.BOP, BlockTypeEnum.REGULAR));
	public static final RegistryObject<Block> DEAD_BARS = BOP_BLOCKS.register("dead_bars", () -> createBarsBlock(BOPBlockTypeEnum.BOP, BlockTypeEnum.REGULAR));
	public static final RegistryObject<Block> MAGIC_BARS = BOP_BLOCKS.register("magic_bars", () -> createBarsBlock(BOPBlockTypeEnum.BOP, BlockTypeEnum.REGULAR));
	public static final RegistryObject<Block> UMBRAN_BARS = BOP_BLOCKS.register("umbran_bars", () -> createBarsBlock(BOPBlockTypeEnum.BOP, BlockTypeEnum.REGULAR));
	public static final RegistryObject<Block> HELLBARK_BARS = BOP_BLOCKS.register("hellbark_bars", () -> createBarsBlock(BOPBlockTypeEnum.BOP, BlockTypeEnum.REGULAR));

	public static final RegistryObject<Block> CROSSED_FIR_BARS = BOP_BLOCKS.register("crossed_fir_bars", () -> createBarsBlock(BOPBlockTypeEnum.BOP, BlockTypeEnum.CROSSED));
	public static final RegistryObject<Block> CROSSED_REDWOOD_BARS = BOP_BLOCKS.register("crossed_redwood_bars", () -> createBarsBlock(BOPBlockTypeEnum.BOP, BlockTypeEnum.CROSSED));
	public static final RegistryObject<Block> CROSSED_CHERRY_BARS = BOP_BLOCKS.register("crossed_cherry_bars", () -> createBarsBlock(BOPBlockTypeEnum.BOP, BlockTypeEnum.CROSSED));
	public static final RegistryObject<Block> CROSSED_MAHOGANY_BARS = BOP_BLOCKS.register("crossed_mahogany_bars", () -> createBarsBlock(BOPBlockTypeEnum.BOP, BlockTypeEnum.CROSSED));
	public static final RegistryObject<Block> CROSSED_JACARANDA_BARS = BOP_BLOCKS.register("crossed_jacaranda_bars", () -> createBarsBlock(BOPBlockTypeEnum.BOP, BlockTypeEnum.CROSSED));
	public static final RegistryObject<Block> CROSSED_PALM_BARS = BOP_BLOCKS.register("crossed_palm_bars", () -> createBarsBlock(BOPBlockTypeEnum.BOP, BlockTypeEnum.CROSSED));
	public static final RegistryObject<Block> CROSSED_WILLOW_BARS = BOP_BLOCKS.register("crossed_willow_bars", () -> createBarsBlock(BOPBlockTypeEnum.BOP, BlockTypeEnum.CROSSED));
	public static final RegistryObject<Block> CROSSED_DEAD_BARS = BOP_BLOCKS.register("crossed_dead_bars", () -> createBarsBlock(BOPBlockTypeEnum.BOP, BlockTypeEnum.CROSSED));
	public static final RegistryObject<Block> CROSSED_MAGIC_BARS = BOP_BLOCKS.register("crossed_magic_bars", () -> createBarsBlock(BOPBlockTypeEnum.BOP, BlockTypeEnum.CROSSED));
...
//	}
	...
	private static HorizontalBarsSlabBlock createHorizontalBarsBlock(BlockType... types) {
		return new HorizontalBarsSlabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).sound(SoundType.WOOD).strength(3.0F, 4.0F).noOcclusion().isValidSpawn(ABBlocksBOP::never).isViewBlocking(ABBlocksBOP::never).isSuffocating(ABBlocksBOP::never).isRedstoneConductor(ABBlocksBOP::never), types);
	}
